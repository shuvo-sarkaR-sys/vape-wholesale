  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-red-600 via-[#62cdd9] to-red-600" />
        <div className="absolute top-0 right-0 h-28 w-28 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#62cdd9]/5 to-transparent pointer-events-none" />

        {/* Modal Header */}
        <div className="flex justify-between items-start mb-6">
          <div>
            <span className="text-[10px] tracking-[0.3em] font-mono text-[#62cdd9] uppercase flex items-center gap-1.5 mb-1 bg-[#62cdd9]/10 px-2 py-0.5 rounded-full w-fit font-bold">
              <Key size={11} /> ADMIN OTP ENTRY
            </span>
            <h3 className="text-xl font-light tracking-tight text-white mt-2">
              Administrator <span className="font-semibold text-[#62cdd9]/80">Login Terminal</span>
            </h3>
        ...
        <div className="bg-neutral-950 border border-neutral-850/80 rounded-xl p-4 text-left mb-6 relative overflow-hidden">
          <div className="absolute top-0 right-0 bg-[#62cdd9]/10 text-[8px] font-mono font-bold text-[#62cdd9]/80 uppercase px-2 py-0.5 rounded-bl">
            LOGIN + RECOVERY
          </div>
          <span className="text-[9px] font-mono tracking-wider text-[#62cdd9]/80 uppercase font-bold flex items-center gap-1 mb-1.5">
          ...
          {!isResetMode ? (
            ...
            >
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-neutral-950 border border-neutral-800 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:outline-none focus:border-[#62cdd9]/50 focus:ring-1 focus:ring-[#62cdd9]/20 transition-all font-mono placeholder-neutral-700"
                  />
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    className="text-[10px] font-mono text-[#62cdd9] hover:text-[#62cdd9]/80 transition-colors cursor-pointer"
                    disabled={isLoading}
                  >
                    Forgot password?
                  </button>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-neutral-950 border border-neutral-800 rounded-lg pl-10 pr-10 py-2.5 text-xs text-white focus:outline-none focus:border-[#62cdd9]/50 focus:ring-1 focus:ring-[#62cdd9]/20 transition-all font-mono placeholder-neutral-700"
                  />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-4 bg-[#62cdd9] hover:bg-[#62cdd9]/80 disabled:bg-neutral-850 text-neutral-950 disabled:text-neutral-600 font-mono tracking-widest uppercase text-xs font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-lg active:translate-y-[1px]"
              >
                {isLoading ? (
                  <>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setEmail(e.target.value)}
                    placeholder="admin@yourdomain.com"
                    className="w-full bg-neutral-950 border border-neutral-800 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:outline-none focus:border-[#62cdd9] focus:ring-1 focus:ring-[#62cdd9]/20 transition-all font-mono placeholder-neutral-700"
                  />
                  <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 text-neutral-500" size={14} />
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="123456"
                        className="w-full bg-neutral-950 border border-neutral-800 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:outline-none focus:border-[#62cdd9] focus:ring-1 focus:ring-[#62cdd9]/20 transition-all font-mono placeholder-neutral-700 tracking-[0.45em]"
                      />
                      <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-neutral-500" size={14} />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-neutral-950 border border-neutral-800 rounded-lg pl-10 pr-10 py-2.5 text-xs text-white focus:outline-none focus:border-[#62cdd9] focus:ring-1 focus:ring-[#62cdd9]/20 transition-all font-mono placeholder-neutral-700"
                      />
                      <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-neutral-500" size={14} />
                      <button
                        type="button"
              ...
              <div className="space-y-2">
                ...
                {isOtpSent && (
                  <button
                    ...
                    className="w-full mt-2 bg-[#62cdd9] hover:bg-[#62cdd9]/80 disabled:bg-neutral-850 text-neutral-950 disabled:text-neutral-600 font-mono tracking-widest uppercase text-xs font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-lg active:translate-y-[1px]"
                  >
                    {isLoading ? (
                      <>
                        <Loader2 size={14} className="animate-spin" />
